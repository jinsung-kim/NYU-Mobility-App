...
// Used for buttons / labels -> CustomButton, background color
enum Colors {
    ...
    static let gray = UIColor(red: 220/255, green: 220/255, blue: 220/255, alpha: 1.0)
    static let nyuPurple = UIColor(red: 101/255, green: 8/255, blue: 159/255, alpha: 1.0) // background color for most screens
}
